...
namespace Fenrir.Multiplayer.LiteNet
{
    ...
    public static class FenrirServerExtensionMethods
    {
        ...
        public static void AddLiteNet(this FenrirServer server)
        {
        ...
        public static void AddLiteNet(this FenrirServer server, ushort port, string bindIPv4)
        {
        ...
        public static void AddLiteNet(this FenrirServer server, ushort port, string bindIPv4, string bindIPv6, IPv6ProtocolMode ipv6Mode)
        {
